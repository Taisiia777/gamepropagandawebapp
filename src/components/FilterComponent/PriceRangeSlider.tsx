...
//     onChange: () => void; // Добавляем onChange как свойство
// }
//
//
...
//     const minGap = 0;
//
//     // Функции для обновления ползунков и вызова onChange
//     const handleMinChange = (e: React.ChangeEvent<HTMLInputElement>) => {
//         const value = Number(e.target.value);
//         if (value + minGap <= maxPrice) {
//             setMinPrice(value);
//             onChange(); // Вызываем onChange при изменении минимальной цены
//         }
//     };
//
...
//             setMaxPrice(value);
//             onChange(); // Вызываем onChange при изменении максимальной цены
//         }
//     };
